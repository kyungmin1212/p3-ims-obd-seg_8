_base_ = [
    '/opt/ml/code/mmdetection_trash/configs/_base_/datasets/coco_instance.py',
    '/opt/ml/realcode/swinb_htc_plus/schedule_1x.py', '/opt/ml/code/mmdetection_trash/configs/_base_/default_runtime.py'
]
 ...
 # segmentation 적용을 위해 with_seg=True
    ...
    dict(type='AutoAugment',
         policies=[
             [
                 dict(type='Resize',
                      img_scale=[(352, 512), (368, 512), (384, 512), (400, 512),
                                 (416, 512), (432, 512), (448, 512), (464, 512),
                                 (480, 512), (496, 512), (512, 512)],
                      multiscale_mode='value',
                      keep_ratio=True)
             ],
             [
                 dict(type='Resize',
                      img_scale=[(312, 512), (412, 512), (512, 512)],
                      multiscale_mode='value',
                      keep_ratio=True),
